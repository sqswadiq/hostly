...
export default function About() {
  return (
    <section className="bg-hostly-primary -mt-10 md:-mt-0">
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-12 lg:py-20">
        {/* Story Section */}
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-12 sm:mb-16 lg:mb-20">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6 leading-relaxed">
              Hostly is a modern co-living concept crafted with comfort,
              simplicity, and community in mind. We understand that finding the
              right place to stay isn't just about four walls and a roof — it's
              about creating an environment where you can thrive, connect, and
              truly belong.
            </p>
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
              Born from the vision of redefining hostel living, we've created
              spaces that prioritize safety, comfort, and community building,
              setting new standards for co-living experiences.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center group sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                Every corner is designed with your comfort in mind. From cozy
                private spaces to welcoming common areas, we ensure you feel at
                ease from day one.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                We've streamlined the living experience, making it effortless to
                move in, settle down, and focus on what truly matters to you.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                ...
                friendships in our thoughtfully designed community spaces that
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Our flagship location in the heart of Kozhikode, offering
                      easy access to the city's business districts, educational
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Secure, comfortable, and empowering spaces designed
                      specifically for women, with 24/7 security and
                      women-focused amenities.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Expanding our footprint across major Indian cities,
                      bringing the Hostly experience to students and
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">
                      All-Gender Accommodations
                    </h4>
                    <p className="text-gray-600">
                      Introducing male and mixed-gender hostels, creating
                      diverse communities while maintaining our commitment to
                      safety and comfort.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm">
                Modern amenities and thoughtful design in every space
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm">
                24/7 security and comprehensive safety measures
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm">
                Simple booking process and flexible stay options
              </p>
            </div>
          </div>
        </div>
