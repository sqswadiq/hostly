    ...
    <footer id="contact" className="bg-slate-900 text-hostly-primary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
          {/* Brand & Social */}
          <div>
            <h3 className="text-2xl font-bold text-hostly-primary mb-4">
              Hostly
            </h3>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Your Space Your Way - Experience modern living with premium
              amenities. We provide affordable & comfortable accommodations for
              students and professionals.
            </p>

            <h4 className="text-lg font-semibold mb-3 text-hostly-primary">
              Follow Us
            </h4>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/hostly.__"
                target="_blank"
              ...
              <a
                href="https://wa.me/919446588033?text=Hello"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-hostly-primary text-hostly-accent p-3 rounded-full hover:bg-yellow-400 hover:scale-110 transition-transform"
              >
              ...
              <a
                href="mailto:support@hostly.co.in?subject=Hello&body=I want to know more about your services"
                className="bg-hostly-primary text-hostly-accent p-3 rounded-full hover:bg-yellow-400 hover:scale-110 transition-transform"
              >
                <Mail size={20} />
              </a>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-6 text-hostly-primary">
              Get in Touch
            </h4>
            ...
            <div className="flex items-start space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-hostly-primary text-sm">
                  Thondayad, Pipe Line Road
                  <br />
                  Near Star Care Hospital
                  <br />
                  Kozhikode, Kerala
                </p>
              </div>
      ...
      <div className="border-t border-gray-800 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="hover:text-hostly-primary transition">
              Privacy Policy
            </a>
            <a href="#" className="hover:text-hostly-primary transition">
              Terms of Service
